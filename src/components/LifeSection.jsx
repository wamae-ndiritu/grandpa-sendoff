...
const LifeSection = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between bg-gray-100 p-5 md:p-10'>
      {/* English Version */}
        ...
        <div className='space-y-6'>
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              Village, Kirichu Sub-location, Kiganjo Location, Nyeri County. His
              parents were the Late Mata Wamai and the Late Kabugo Matu. He was
              brother to Theuri Matu and many others who shared the same father.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              carried out by the colonial government including the construction
              of the Jomo Kenyatta International Airport. They worked as slaves
              following their failure to collaborate with the Mzungu. He never
              collaborated with them unlike the so called Kamatimu/Ngati. He has
              lived to enjoy the fruits of the struggle for independence and
              always called for unity of our country
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              The Late Mzee Ngariuku wa Matu worked in masonry both as a casual
              labourer and employed. He was employed by the Kenya Police
              College, Kiganjo as a mason. He worked there up to his retirement.
              He was industrious and has equipped several people with the same
              skills that has earned them a living.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              days. On Monday, 2<sup>nd</sup> September early morning, he passed
              away. He has left many sons and daughters, grand-children and
              great grand-children. He passed at the age of 98yrs. We are
              grateful to the Almighty Lord for the many years he had given us
              to live with one who was a father, grandfather and
              great-grandfather, Mzee Ngariuku wa Matu. May the name of the Lord
              be blessed.
            </p>
          </div>
        </div>
      ...
      <div className='w-full md:w-1/2 bg-white border-2 border-black rounded-md p-4 md:ml-4'>
        ...
        <div className='space-y-6'>
          <div>
            ...
            <p className='text-sm mt-2'>
              Mutiga-iri Muthee Ngariuku wa Matu ni aciarirwo mwaka-ini wa 1926
              itura-ini ria Gachika Sub-location, Kiganjo location, Nyeri
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              Muthee Ngariuku ari munini ni akurire ena wathiki muingi na wendo
              kuri aciari ake. Ni ateithagia aciari ake wiraina wa kurima na
              kurithia ng’ombe cia ithe.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              cukuru-ini wa Kirichu Primary School. Kuma hau niathire wiraini wa
              marimia.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              niwe mwendwani-iri Ann Wairimu. Nimatanahirwo na ciana inyanya nio
              mwendwani-iri Purity Nyaruai Rukwaro, Winrose Gathoni,
              mwendwani-iri Nancy Wangui Mburu, Margaret Wangeci Waweru, William
              Matu, Mutiga-iri Gilbert Maina, Tabitha Muringi Munuhe na Phillip
              Wamai.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              Mutiga-iri Muthee Ngariuku wa Matu arari murumiriri wa kanitha wa
              Orthodox o-ginya kuhuruka gwake.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              Muthee Ngariuku niathire na mbere na wira wake wa marimia ta fundi
              wa miako ya mahiga. Niacokire akiandikwa Kenya Police College,
              Kiganjo ari fundi, kuria arutire wira wake ginya kuritaya gwake.
              Niari na kio wira-ini wake na agitiga aruta andu aingi wira ucio
              arutaga.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-sm mt-2'>
              ...
              Muthee Ngariuku wa Matu. Arahurukire ari na ukuru wa miaka mirongo
              kenda na inana(98yrs). Ritwa ria Mwathani rirogocwo.
            </p>
          </div>
        </div>
      </div>
